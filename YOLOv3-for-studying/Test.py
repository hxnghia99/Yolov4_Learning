...
# IMAGE_PATH = "./YOLOv3-for-studying/IMAGES/lg_street3.jpg"
# yolo = Load_YOLOv3_Model()
# image = detect_image(yolo, IMAGE_PATH, show=True, save=False, CLASS_FILE=YOLO_CLASS_DIR)
# #############################################################################################
...
yolo = Load_YOLOv3_Model()
pred_image = detect_image(yolo, image_path, show=False, save=False, CLASSES_PATH=YOLO_CLASS_PATH)

image = cv2.imread(image_path)
image = draw_bbox(image, bboxes, YOLO_CLASS_PATH)
