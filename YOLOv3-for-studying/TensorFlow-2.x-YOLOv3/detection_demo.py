...
image_path   = "./YOLOv3-for-studying/TensorFlow-2.x-YOLOv3/IMAGES/kite.jpg"
video_path   = "./YOLOv3-for-studying/TensorFlow-2.x-YOLOv3/IMAGES/test.mp4"

yolo = Load_Yolo_model()
detect_image(yolo, image_path, "./YOLOv3-for-studying/TensorFlow-2.x-YOLOv3/IMAGES/kite_pred.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
