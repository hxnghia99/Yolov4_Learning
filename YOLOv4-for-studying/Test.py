...
image_truth = draw_bbox(np.copy(original_image), bboxes, CLASSES_PATH=YOLO_CLASS_PATH, show_label=True)
...
image_pred = draw_bbox(np.copy(original_image), pred_bboxes, CLASSES_PATH=YOLO_CLASS_PATH, show_confidence=True, show_label=True) #draw bboxes
